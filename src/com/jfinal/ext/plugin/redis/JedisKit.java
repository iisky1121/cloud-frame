...
public class JedisKit {
	...
	static void init(JedisPoolConfig config, String host, int port, String password){
		if(config == null){
	...
	static void init(JedisPool pool){
		if(pool != null)
			...
			throw new RuntimeException("Attribute pool not allowed to empty");
		}
	}
	...
	public static class Sets {
		 ...
		 * @return 新集合中的记录数
		 * **/
		public static long interstore(String newkey, String... keys) {
			Jedis jedis = getJedis();
