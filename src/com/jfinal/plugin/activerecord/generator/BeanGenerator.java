...
public class BeanGenerator {
	...
	protected String classDefineTemplate =
			"/**%n" +
					...
					" */%n" +
					"public class %s implements IBean {%n";
	protected String classDefineForSetterChainTemplate =
			"/**%n" +
					" * Generated by JFinal, do not modify this file.%n" +
					" */%n" +
					"public class %s implements IBean {%n";
	protected String fieldTemplate = "\tprivate %s %s;%n";
	...
	public BeanGenerator(String beanPackageName, String beanOutputDir) {
		if (StrKit.isBlank(beanPackageName)) {
		...
		if (StrKit.isBlank(beanOutputDir)) {
	...
	public void generate(List<TableMeta> tableMetas) {
		...
		System.out.println("Bean Output Dir: " + beanOutputDir);
		for (TableMeta tableMeta : tableMetas) {
			genBaseBeanContent(tableMeta);
		}
		writeToFile(tableMetas);
	}

	protected void genBaseBeanContent(TableMeta tableMeta) {
		StringBuilder ret = new StringBuilder();
		genPackage(ret);
		genImport(ret);
		genClassDefine(tableMeta, ret);
		genFieldDefine(tableMeta, ret);
	...
	protected void genClassDefine(TableMeta tableMeta, StringBuilder ret) {
		...
		ret.append(String.format(template, beanName(tableMeta.modelName)));
	}

	public void genFieldDefine(TableMeta tableMeta, StringBuilder ret){
		for(ColumnMeta meta : tableMeta.columnMetas){
			ret.append(String.format(fieldTemplate, meta.javaType, meta.name));
		}
		ret.append(String.format("%n"));
	}
	...
	protected void writeToFile(TableMeta tableMeta) throws IOException {
		...
		String target = beanOutputDir + File.separator + beanName(tableMeta.modelName) + ".java";
	...
	private static String beanName(String modelName){
		return "Bean".concat(modelName);
	}
}
