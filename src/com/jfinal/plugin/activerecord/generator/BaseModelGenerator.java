...
public class BaseModelGenerator {
	...
	protected void genImport(TableMeta tableMeta, StringBuilder ret) {
		ret.append(String.format(importTemplate, tableMeta.modelExtendsClass.getName()));
	}
	
	protected void genClassDefine(TableMeta tableMeta, StringBuilder ret) {
		String template = generateChainSetter ? classDefineForSetterChainTemplate : classDefineTemplate;
		ret.append(String.format(template, tableMeta.baseModelName, tableMeta.baseModelName, tableMeta.modelExtendsClass.getSimpleName()));
	}
